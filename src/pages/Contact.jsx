...
import contact from '../assets/images/contact.mp4'
...
const Contact = () => {
 const [menuOpen, setMenuOpen] = useState(false);
  ...
  return (
    <div className="fmin-h-screen flex flex-col justify-center  sm:px-6 lg:px-8 relative font-serif">
        <video className="absolute inset-0 w-full h-screen object-cover" autoPlay muted loop>
        ...
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${menuOpen ? 'block' : 'hidden'}`} id="navbar-sticky">
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 bg-transparent md:bg-transparent md:shadow-none shadow-lg md:w-auto max-w-xs md:max-w-none">
            ...
            <li className="flex items-center">
              ...
              <Link to="/Contact" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 text-lg">Contact</Link>
            </li>
          </ul>
        </div>
      </div>
    </nav>
      <div className="flex-grow  font-serif z-30 mt-24">        
        <div className="flex items-center justify-center mx-12">
          <div className="mx-auto w-full max-w-[550px] ">
            {/* Form Section */}
            <div className="flex items-center justify-center mx-12">
          <div className="mx-auto w-full max-w-[550px] bg-opacity-50 bg-white border border-gray-300 rounded-lg p-6">
